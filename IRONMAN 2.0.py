...
# Google Maps API key
google_maps_api_key = "AIzaSyDzzYB6-Mkye9_jVSLOsMZUnH5eOQsGqz8"

API_KEY = 'AIzaSyDfoPqFtxATevsBq1ZaLbQg2nLY2k3239w'
ai.configure(api_key=API_KEY)

model = ai.GenerativeModel("gemini-pro")
chat = model.start_chat()

messages = [{"role": "system", "content": "i am MAHI you need to do whatever i said to do. your name is IRONMAN"}]
...
def CustomChatGPT(user_input):
    ...
    if "weather" in user_input.lower():
        ...
        api_key = 'b2c3611de5cf4949b5860049242604'
...
bg_image = Image.open("thanos.jpg")
